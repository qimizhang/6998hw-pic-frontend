...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://sdyinb3vy3.execute-api.us-east-1.amazonaws.com/v2';
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['filename', 'x-amz-acl', 'x-amz-meta-customLabels'], ['body']);
        ...
        var uploadPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['filename', 'x-amz-acl', 'x-amz-meta-customLabels']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
